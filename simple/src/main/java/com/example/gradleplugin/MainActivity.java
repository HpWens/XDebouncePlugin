...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_click_8).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (clickMethodProxy == null) {
                    clickMethodProxy = new ClickMethodProxy();
                }
                if (!clickMethodProxy.onClickProxy(MethodHookParam.newInstance("android.view.View$OnClickListener", "onClick", new Object[]{view}))) {
                    LogUtil.d("事件回调了");
                    Toast.makeText(MainActivity.this, "事件回调了", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                    clickMethodProxy = new ClickMethodProxy();
//                }
//                if (clickMethodProxy.onClickProxy(MethodHookParam.newInstance("android.view.View$OnClickListener", "onClick", new Object[]{v}))) {
//                    LogUtil.d("事件回调了");
//                    Toast.makeText(MainActivity.this, "事件回调了", Toast.LENGTH_SHORT).show();
//                }
//            }
